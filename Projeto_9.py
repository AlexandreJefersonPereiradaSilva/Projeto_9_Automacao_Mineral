...
print("Abrindo navegador 'acessar SIGMINE'...")
...
print("Procurando link para download...")

pyautogui.moveTo(850, 600)
pyautogui.click()

print(f"Aguardando {tempo_download} segundos para download ser concluído...")
time.sleep(tempo_download)

print("Download concluído! Processo feito com sucesso!:D")